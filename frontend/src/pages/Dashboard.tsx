  ...
  return (
    <section className="min-h-screen bg-tijolo-fundo bg-cover bg-center bg-no-repeat">
      ...
      <section className="p-8">
        <section>
          <h1 className="text-3xl text-amber-700 mb-4 font-bold border-b-2 border-orange-500 pb-2 inline-block"> Gerenciamento de Vendedores</h1>
        </section>
        ...
        <section className="bg-slate-800 p-6 rounded-lg mb-10 flex gap-4 items-end shadow-xl">
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 px-6 py-2 rounded font-bold transition-colors active:scale-95 hover:scale-90 duration-500"> Adicionar +
          </button>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vendedores.map((v) => (
            <section key={v.id} className="bg-slate-800 p-6 rounded-lg border-l-4 border-orange-500 shadow-lg transition-all active:scale-95 hover:scale-90 duration-500">
                ...
                <>
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-3">
                      <button onClick={() => iniciarEdicao(v)} className="text-slate-400 hover:text-blue-900 transition-colors">✏️</button>
                      <button onClick={() => deletarVendedor(v.id)} className="text-slate-400 hover:text-red-800 transition-colors">🗑️</button>
                    </div>
                  </div>
