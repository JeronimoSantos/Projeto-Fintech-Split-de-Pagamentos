...
export const SimuladorVenda = () => {
  ...
  return (
    <section className="min-h-screen bg-linear-to-br from-orange-600 to-black p-8 text-white">
      <section className="max-w-md mx-auto bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
        ...
        <div className="space-y-4"> {/* Seleção do Vendedor */}
          ...
          <button onClick={handleConfirmar} className="w-full py-3 bg-orange-500 hover:bg-orange-600 rounded-xl font-bold transition-all shadow-lg shadow-orange-500/20 active:scale-95">
